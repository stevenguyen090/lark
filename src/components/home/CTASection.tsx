  ...
  return (
    <section ref={ref} className="relative overflow-hidden text-center" style={{ padding: "96px 0" }}>
      ...
      <div className="container-content relative z-[1]">
        ...
        <p className="body-lg max-w-[480px] mx-auto mb-10 reveal reveal-d1">Bắt đầu bằng buổi tư vấn miễn phí 60 phút — không ràng buộc.</p>
        <div className="flex gap-3 justify-center flex-wrap mb-8 reveal reveal-d2">
          <a href="https://larkconsult.sg.larksuite.com/share/base/form/shrlgQE4t5vcnWnbcDirbBCXj9d" target="_blank" rel="noopener noreferrer" className="btn-glow">Đặt lịch tư vấn →</a>
