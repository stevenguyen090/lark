      ...
      <div className="container-content">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-12 items-start">
          ...
          <div className="card-dark p-8 reveal">
            ...
            <ul className="flex flex-col gap-3 mb-6 list-none">
              {["1 buổi tư vấn 60 phút (online/offline)", "Phân tích mô hình vận hành hiện tại", "Xác định 2–3 điểm nghẽn chính", "Đề xuất hướng giải quyết phù hợp", "Không ràng buộc, không áp lực mua thêm"].map((f, i) => (
            ...
            <a href={CTA_LINK} target="_blank" rel="noopener noreferrer" className="btn-ghost w-full justify-center">Đặt lịch ngay →</a>
          </div>
          {/* Gói 2 */}
          <div className="card-dark card-featured p-8 relative reveal reveal-d1">
            ...
            <a href={CTA_LINK} target="_blank" rel="noopener noreferrer" className="btn-primary w-full justify-center">Nhận báo giá →</a>
          </div>
          {/* Gói 3 */}
          <div className="card-dark p-8 reveal reveal-d2">
            ...
            <a href={CTA_LINK} target="_blank" rel="noopener noreferrer" className="btn-ghost w-full justify-center" style={{ borderColor: "rgba(6,182,212,0.3)", color: "#22D3EE" }}>Nhận báo giá →</a>
          </div>
        </div>
        {/* Guarantee */}
        <div className="mt-10 reveal">
          <div className="flex gap-6 items-start rounded-[20px] p-8 px-10" style={{ background: "#0E1E35", border: "1px solid rgba(37,99,235,0.35)" }}>
            ...
            <div>
              <div className="text-sm font-bold text-t-primary mb-4">Cam kết của Lark Consult</div>
              <div className="flex flex-col gap-3">
                {[
                  "Chỉ thanh toán khi nghiệm thu đúng yêu cầu đã thống nhất — không nghiệm thu, không thu phí",
                  "Đồng hành liên tục cho đến khi doanh nghiệp vận hành thực sự ổn định — không giới hạn thời gian",
                ].map((item, i) => (
